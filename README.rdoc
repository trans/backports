<b>This is a personal fork, archived for reference. It contains a TracePoint backport for Ruby 2.0.0 (see PR #68 on marcandre/backports) that was never merged upstream. The TracePoint code has been preserved in rubyunworks/tracepoint. This fork will eventually be deleted.</b>
